...
export default function DashboardLayout({ children }) {
    return (
        <>
            <aside id="default-sidebar" className="fixed my-16 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                        ...
                        <li>
                            <Link href="#" legacyBehavior>
                                <a className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Shorten URL</span>
                        ...
                        <li>
                            <Link href="#" legacyBehavior>
                                <a className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Shorted URLs</span>
                                </a>
                            </Link>
                        </li>
